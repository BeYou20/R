document.addEventListener('DOMContentLoaded', () => {
    ...
    let decodedCourseName = ''; // تعريف المتغير هنا

    if (courseName) {
        decodedCourseName = decodeURIComponent(courseName);
        // تم حذف سطر set value الخاص بالحقل المخفي
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            // إضافة اسم الدورة يدوياً إلى بيانات النموذج قبل الإرسال
            if (decodedCourseName) {
                formData.append('CourseName', decodedCourseName);
            }
